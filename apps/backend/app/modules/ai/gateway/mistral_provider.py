"""Mistral chat completions via httpx."""
...
class MistralProvider(AIProvider):
    ...
    def __init__(self, api_key: str, model: str, *, base_url: str = "https://api.mistral.ai/v1", timeout: float = 60.0):
    ...
    async def generate_request(self, request: GenerateRequest) -> AIResponse:
        ...
        if not choices:
            raise ProviderError(PROVIDER_INVALID_RESPONSE, "Mistral returned no choices", provider=self.name)
