...
difficulty. Every question must be answerable purely from the given excerpt — do not \
introduce facts, numbers, or claims the excerpt doesn't support. Each question must have \
exactly one unambiguously correct option, and the two questions must test different aspects \
of the excerpt (not near-duplicates of each other)."""
