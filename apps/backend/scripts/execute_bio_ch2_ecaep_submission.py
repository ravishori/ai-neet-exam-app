"""Execute atomic ECAEP submit_for_review for Biology Ch2 100 DRAFTs.
...
Usage:
  python scripts/execute_bio_ch2_ecaep_submission.py --commit
  python scripts/execute_bio_ch2_ecaep_submission.py --dry-preflight
"""
