"""READ-ONLY ECAEP submission dry-run for Biology Ch3 batch.
...
Usage:
  python scripts/ecaep_bio_ch3_submission_dry_run.py
"""
...
def is_batch_item(item: ContentItem) -> bool:
    ...
    if BATCH in tags or any(BATCH in (t or "") for t in tags):
        return True
    return bool(item.slug and "bio11-ch03-b001" in item.slug.lower())
...
async def main() -> int:
    async with AsyncSessionLocal() as session:
        ...
        safety_checks = {
            ...
            "ch02_regression_unchanged": after["ch02_regression"] == EXPECTED_CH02,
            "before": before,
            "after": after,
        }
        ...
        selection_proof = {
            ...
            "proofs": {
                ...
                "all_botany_plant_kingdom": len(wrong_chapter) == 0,
                "ch01_regression_intact": after["ch01_regression"] == EXPECTED_CH01,
                "ch02_regression_intact": after["ch02_regression"] == EXPECTED_CH02,
            },
        }
        ...
        ok = (
            ...
            and selection_proof["proofs"]["all_botany_plant_kingdom"]
            and selection_proof["proofs"]["no_physics"]
            and selection_proof["proofs"]["ch01_regression_intact"]
            and selection_proof["proofs"]["ch02_regression_intact"]
        )
