"""Atomic ECAEP approval for Biology Ch3 100 IN_REVIEW questions.
...
Usage:
  python scripts/execute_bio_ch3_ecaep_approval.py --commit
  python scripts/execute_bio_ch3_ecaep_approval.py --dry-preflight
"""
...
COMMENT = (
    "Biology Ch3 Plant Kingdom ECAEP approval — AI review + adjudication; "
...
def update_pipeline_stage(*, approval_report: dict) -> None:
    ...
    stage = {
        ...
        "explicit_statement": [
            "BIO11-CH03-B001 ECAEP submission, review, adjudication and approval are complete.",
            ...
            "CH03 remains non-student-visible because it is not published.",
        ],
        "held_in_review": held,
        "stages": {
