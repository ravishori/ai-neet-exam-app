...
**Generated:** 2026-09-01T16:01:47.410461+00:00
**Verdict:** **YELLOW**
**Mode:** Full-corpus staging re-OCR with persisted Tesseract word geometry
**Output:** `D:\ravishori\AI Neet Exam App\data\staging\pyq\2020-2025\p2_1e_full_r2`
...
```json
{
  ...
  "cross_paper_repeated_source": 317,
  "truncated_boilerplate": 0,
  "unique_hashes_with_collisions": 196
}
```
